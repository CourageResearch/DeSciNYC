...
const navigation = {
    ...
    join: [
        { name: 'Newsletter', href: '#sign-up' },
        { name: 'Calendar', href: links.luma_calendar_url },
        { name: 'Telegram', href: links.telegram_url },
                    ...
                    <div className="grid grid-cols-2 gap-8 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-10 md:mt-0">
                                <h3 className="text-sm font-semibold leading-6 text-gray-900">Stay In Touch</h3>
                                <ul role="list" className="mt-6 space-y-4">
